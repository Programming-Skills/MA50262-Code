...
digitized.file.names = c("van-cutsem-FTD.tsv", "van-cutsem-Placebo.tsv")
...
numbers.below.figure = list(  
  van.cutsem.FTD = c(534, 521, 499, 459, 406, 355, 308, 267, 
                         231, 212, 180, 156, 137, 117, 95, 74, 59, 49, 38, 29, 20, 17, 14, 12, 10, 7, 4, 1),    
  van.cutsem.Placebo = c(266, 259, 232, 198, 163, 137, 114, 
...
time = list( time.van.cutsem.FTD = 0:28, 
             time.van.cutsem.Placebo = 0:28
)
