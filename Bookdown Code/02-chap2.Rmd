...
```{r, results="asis", echo=FALSE, fig.cap="Patients in the WT population", out.extra="scale=0.55", fig.align='center', eval=T}
knitr::include_graphics("figure/reck.pdf")
```

```{r, fig.cap="Patients in the WT population", echo=FALSE, eval=F}
