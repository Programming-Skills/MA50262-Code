...
digizeit <- read.csv("nivolumab.csv", header=FALSE)
# digizeit <- read.csv("IPD.Brahmer.a.docetaxel.csv", header=FALSE)
t.S<-digizeit[,1]
S<-digizeit[,2]
...
# saveRDS(IPD, file = "IPD.Brahmer.a.docetaxel.RDS") 
# saveRDS(IPD, file = "IPD.Brahmer.a.nivolumab.RDS") 

# Restore the object
# readRDS(file = "IPD.Brahmer.a.docetaxel.RDS")
# readRDS(file = "IPD.Brahmer.a.nivolumab.RDS")

IPD.Brahmer.a <- rbind(IPD.Brahmer.a.docetaxel, IPD.Brahmer.a.nivolumab)

saveRDS(IPD, file = "IPD.Brahmer.a.RDS") 

IPD.Brahmer.a.time <- rbind(IPD.Brahmer.a.docetaxel, IPD.Brahmer.a.nivolumab)[,1]
IPD.Brahmer.a.event <- rbind(IPD.Brahmer.a.docetaxel, IPD.Brahmer.a.nivolumab)[,2]
IPD.Brahmer.a.arm <- rbind(IPD.Brahmer.a.docetaxel, IPD.Brahmer.a.nivolumab)[,3]

IPD.Brahmer.a <- as.data.frame(x = IPD.Brahmer.a)
...
km_fit <- survfit(Surv(IPD.Brahmer.a.time, IPD.Brahmer.a.event) ~ 1, data = IPD.Brahmer.a)
summary(km_fit)
