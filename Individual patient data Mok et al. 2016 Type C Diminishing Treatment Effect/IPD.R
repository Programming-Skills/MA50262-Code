...
digitized.file.names = c("mok.a.caroplatin.tsv", "mokg.tsv")
...
numbers.below.figure = list(  
  mok.a.caroplatin = c(608, 412, 118, 22, 3,1,0),
  mok.a.gefitinib = c(609, 363, 212, 76, 24, 5, 0)
...
time = list( time.mok.a.caroplatin = 0:23, 
             time.mok.a.gefitinib = 0:23
)
